...
function a:Window(f, f, f)
    ...
    j.Text = "Kurumi HUB ".." "..""..game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name
    j.TextSize = 15.000
    ...
    function d:Tab(d, f)
        ...
        function a:Toggle(a, b, d)
            ...
            o.Image = "rbxassetid://16780924356"
            j.Parent = h
        ...
        function a:Dropdown(a, b, d)
            ...
            f.Image = "rbxassetid://16780924356"
            k.Name = "DropTitle"
            k.Parent = g
        ...
        function a:Slider(a, c, d, e, g)
            ...
            l.Image = "rbxassetid://16780924356"
            m.Parent = j
        ...
        function a:Slider2(a, b, c, d, e)
            ...
            k.Image = "rbxassetid://16780924356"
            l.Parent = i
